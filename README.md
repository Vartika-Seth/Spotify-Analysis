...
![Dataset](https://img.shields.io/badge/Dataset-100K+%20Tracks-1DB954?style=flat&logo=spotify&logoColor=white)

> **Analyzing 100,000+ Spotify tracks to uncover what makes a song popular, how music has evolved across decades, and which audio features separate hit songs from everything else.**

---

## 📌 Questions This Project Answers

- What does the popularity distribution across 100K+ Spotify songs look like?
...
### Finding 2 — The sweet spot for song length is 2.5 – 4 minutes
...
### Finding 3 — Genre mood landscape
...
### Finding 4 — Correlation heatmap reveals no single feature predicts popularity
...
│   ├── 07_mood_by_genre.png
│   ├── 08_mood_quadrant.png
...
| 7. Mood Analysis | Happiest/darkest genres, mood quadrant scatter |
| 8. Plotly Interactive | Genre popularity bar, energy vs popularity scatter |
| 9. Key Findings | Narrative summary of all insights |
...
🔗 [LinkedIn](https://www.linkedin.com/in/vartika-seth-228183315) · [GitHub](https://github.com/Vartika-Seth)

---

*Part of my data analyst portfolio. See also: [Retail Sales Analysis (Power BI)](../retail-sales-powerbi) ·*
